export const AppConfig={
  ...
  chordPatterns:[
    ...
    {sym:'+add9',name:'Augmented add 9',longName:'augmented add nine',intervals:[0,2,4,8]},
    ...
    {sym:'+addb9',name:'Augmented add flat 9',longName:'augmented add flat nine',intervals:[0,1,4,8]},
    ...
    {sym:'+add#9',name:'Augmented add sharp 9',longName:'augmented add sharp nine',intervals:[0,3,4,8]},
